...
- Service worker live: `myfinance-v30` (sinkron lokal). Suite: **452 unit + 1 smoke, semua hijau**.
...
- **Bentuk kode**: `index.html` masih monolith besar (controller + markup; ekstraksi bertahap ke modul),
  ...
  `chart-hud.js` (DNA grafik garis ala balanceTrend: gradasi neon, area memudar,
  crosshair, glow, sumbu teknis), `src/ui/*` (render),
