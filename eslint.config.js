...

  {
    ...
    languageOptions: {
      globals: {
        ...
        globalData: "readonly",
        // v127: dipakai scripts/bench-load-sync.mjs -- harness mengukur biaya
        // fungsi-fungsi ini dari dalam halaman (profil per fungsi & A/B sortir).
        refreshTransactionsOnly: "readonly",
        ...
        searchAssetBankSuggestions: "readonly",
        submitForm: "readonly",
