...
test("dokumen: jumlah cek tiap harness E2E cocok dengan skripnya", () => {
  ...
  const harnesses = ["verify-hud", "verify-asset-logos", "verify-applock", "verify-applock-biometric", "verify-offline-cache", "verify-ui-actions", "verify-csp", "verify-ui-sweep"];
