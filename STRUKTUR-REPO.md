...
> Repo: `wahyudp76/myfinance` · branch `main` · ~417 commit · versi terbaru `v136`
...
│
├── docs/                   # Rencana migrasi, audit, kontrak — 19 dokumen
...
│   │                       #   optimasi yang DIBATALKAN karena pengukurannya berkata
│   │                       #   lain (v127 sortTxRows, v129 keyset paging), koreksi
...
│   ├── audit-ai-2026-09-17.md               # v134: audit jalur AI (Edge Function analyze-finance
│   │                       #   & scan-receipt, payload, rate limit, cache, privasi, uji)
