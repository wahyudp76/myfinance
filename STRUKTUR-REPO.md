...
> Repo: `wahyudp76/myfinance` · branch `main` · ~385 commit · versi terbaru `v104`
...
├── sw.js                   # Service Worker (offline, precache, CACHE_VERSION=v138)
...
- **Verifikasi wajib** sebelum merge:
  ...
  node scripts/verify-ui-actions.mjs  # 31 cek aksi UI deklaratif (data-action)
