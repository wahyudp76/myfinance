...
> Repo: `wahyudp76/myfinance` · branch `main` · ~385 commit · versi terbaru `v101`
...
├── sw.js                   # Service Worker (offline, precache, CACHE_VERSION=v135)
...
- **Verifikasi wajib** sebelum merge:
  ...
  node scripts/verify-ui-actions.mjs  # 18 cek aksi UI deklaratif (data-action)
