...
> Repo: `wahyudp76/myfinance` · branch `main` · ~385 commit · versi terbaru `v102`
...
├── sw.js                   # Service Worker (offline, precache, CACHE_VERSION=v136)
...
- **Verifikasi wajib** sebelum merge:
  ...
  node scripts/verify-ui-actions.mjs  # 26 cek aksi UI deklaratif (data-action)
